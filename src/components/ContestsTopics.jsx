...
const ContestsTopics = () => {
  ...
  return (
    <div className="tw-relative tw-py-16 tw-flex tw-justify-center tw-items-center tw-group tw-bg-imgRed tw-bg-fixed tw-bg-cover ">
      ...
      <div
        className="tw-static tw-z-2 tw-w-[85%] tw-px-5 md:tw-px-3 sm:tw-px-2 tw-mx-auto tw-py-6 tw-my-2 tw-overflow-hidden "
        data-aos="fade-left"
      ...
      >
        ...
        <div className=" tw-grid tw-grid-cols-5 lg:tw-grid-cols-3 md:tw-grid-cols-2 tw-gap-4 tw-items-center tw-mt-8">
